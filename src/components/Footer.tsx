    ...
    <footer className="bg-hero-bg text-white">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand & About */}
          <div>
            <h2 className="hero-title text-2xl font-bold mb-4">ZIDIO</h2>
            <p className="text-white/70 mb-4">
              Connecting fans to their favorite superheroes through high-quality, 
              unique t-shirts and apparel. Express yourself with Zidio.
            </p>
      ...
      <div className="border-t border-white/10 py-6">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm">
            &copy; {new Date().getFullYear()} Zidio. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/shipping" className="text-white/60 text-sm hover:text-white transition-colors">
              Shipping Info
            </Link>
          </div>
        </div>
